...
Access within your workspace is governed by [roles and permissions](/workspace/roles-permissions), and administrative actions are recorded in an append-only [security audit log](/workspace/audit-log) that installation admins can review and export.
