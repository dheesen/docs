...
<CardGroup cols={2}>
  ...
  <Card title="Agent Deployments" icon="rocket" href="/workspace/deployments">
    Once Azotha configures a deployment target, your agent can publish the exact version you approved — and roll back if needed.
  </Card>
</CardGroup>
